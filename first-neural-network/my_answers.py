...
##used https://github.com/llSourcell/how_to_do_math_for_deep_learning/blob/master/demo.ipynb
### https://www.youtube.com/watch?v=q555kfIFUCM
### theory: http://neuralnetworksanddeeplearning.com/chap2.html
### multiple layer https://github.com/ludobouan/pure-numpy-feedfowardNN/blob/master/FeedforwardNN.py
### derivative of sigmoid: https://math.stackexchange.com/questions/78575/derivative-of-sigmoid-function-sigma-x-frac11e-x
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #outout delta is error, because the activation funtion of out is linear
        output_delta = error
        
        # TODO: Calculate the hidden layer's contribution to the error
        hidden_error = np.dot(output_delta, self.weights_hidden_to_output.T)
        #hidden_error = hidden_error * self.activation_function(hidden_outputs)*(1-self.activation_function(hidden_outputs))
        #unclear why x'(1-x) instead of sigmoid(x)*(1-sigmoid(x))
        hidden_error = hidden_error * hidden_outputs*(1-hidden_outputs)
